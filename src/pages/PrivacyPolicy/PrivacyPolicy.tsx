  ...
  return (
    <div className="flex h-screen flex-col items-center">
      ...
      <div className="flex w-full max-w-4xl flex-col gap-4 p-4 pb-8 [&_*]:text-zinc-500">
        <h3 className="pt-4 text-4xl font-bold !text-zinc-900">
          Política de privacidade
        </h3>
        <p className="text-md text-justify">
          Ao entrar para o <b>SOS RS </b>
          <LifeBuoy
            className="padding relative inline-block max-h-6 pb-0.5 align-middle"
            size={18}
          />{' '}
        ...
        <h5 className="pt-4 text-2xl font-bold !text-zinc-900">
        ...
        <ul className="space-y-2">
          <li className="text-md text-justify">
